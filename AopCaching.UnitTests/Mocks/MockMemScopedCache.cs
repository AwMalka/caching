...
{
    public class MockMemScopedCache : IScopedCache
    {
        ...
        public int Skipped { get { return this.innerCache.Skipped; } }
        ...
        public class MockScopedCacheInner : InMemoryScopedCache
        {
            ...
            protected override CacheMethodTaken TryGetScopedInner<TValue>(string key, out ScopedValue<TValue> value)
            {
                ...
                if (cacheMethodTaken.HasFlag(CacheMethodTaken.None)) skipped++;
            ...
            public int Skipped { get { return this.skipped; } }
